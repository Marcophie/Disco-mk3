...
#define STRING_CONFIG_H_AUTHOR "(Marcophie)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Disco Mk3"
 ...
 */
#define TEMP_SENSOR_0 5 //Thermistance origine triangle lab
